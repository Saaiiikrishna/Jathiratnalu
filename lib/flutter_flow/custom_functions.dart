...
List<String>? newCustomFunction(String? selectedValue1) {
  // second dropdown's options change dynamically on the value of the first dropdown
  List<String> newList = [];
  if (selectedValue1 == 'Intraday') {
    newList = ['1 min', '5 mins', '15 mins', '30 mins', '1 hour', '4 hours'];
  } else if (selectedValue1 == 'Delivery') {
    newList = [
      '2 Days',
      '3 Days',
      '4 Days',
...
List<String>? newCustomFunction2(String? selectedValue1) {
  List<String> newList = [];
  if (selectedValue1 == 'Equity') {
    newList = [
      ...
      "Fourth Dimension Solutions Limited - 4THDIM",
      ...
      "GI Engineering Solutions Limited - GISOLUTION",
      ...
      "Kalyani Commercials Limited - KALYANI",
      ...
      "National Steel And Agro Industries Limited - NATNLSTEEL",
      ...
      "Rushil Decor Limited-RE - RUSHI-RE1",
      ...
      "Sri Adhikari Brothers Television Network Limited - SABTN",
      ...
      "Sonam Clock Limited - SONAMCLOCK",
      ...
      "Tantia Constructions Limited - TANTIACONS",
  ...
  } else if (selectedValue1 == 'Options') {
    newList = ['Nifty', 'BankNifty'];
  } else if (selectedValue1 == 'Futures') {
    newList = [
      'Future Contract 1',
      'Future Contract 2',
    ];
  } else if (selectedValue1 == 'MCX') {
    newList = ['MCX Option 1', 'MCX Option 2'];
  }
  return newList;
}
