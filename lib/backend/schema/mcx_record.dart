...
class McxRecord extends FirestoreRecord {
  McxRecord._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('mcx');

  static Stream<McxRecord> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => McxRecord.fromSnapshot(s));

  static Future<McxRecord> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => McxRecord.fromSnapshot(s));

  static McxRecord fromSnapshot(DocumentSnapshot snapshot) => McxRecord._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static McxRecord getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      McxRecord._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'McxRecord(reference: ${reference.path}, data: $snapshotData)';
}

Map<String, dynamic> createMcxRecordData({
