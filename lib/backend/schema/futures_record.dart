...
class FuturesRecord extends FirestoreRecord {
  FuturesRecord._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('futures');

  static Stream<FuturesRecord> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => FuturesRecord.fromSnapshot(s));

  static Future<FuturesRecord> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => FuturesRecord.fromSnapshot(s));

  static FuturesRecord fromSnapshot(DocumentSnapshot snapshot) =>
      FuturesRecord._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static FuturesRecord getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      FuturesRecord._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'FuturesRecord(reference: ${reference.path}, data: $snapshotData)';
}

Map<String, dynamic> createFuturesRecordData({
